...
/**
 * Created by User HMI on 8/28/2017.
 */

public class ListBookingCompleted extends Fragment implements
    ...
    List<ListBookingData> listBookingComplete = new ArrayList<ListBookingData>();
    private static final String TAG = ListBookingCompleted.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.activity_list_booking_completed, container, false);
...
/*
        ...
        */
        ...
        listView = (ListView) v.findViewById(R.id.list_booking_completed);
        listView.setOnItemClickListener(this);

        adapter = new ListBookingAdapter(getActivity(), listBookingComplete);
        listView.setAdapter(adapter);
        listBookingComplete.clear();
...
*/
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(Config.CEK_KONEKSI(getActivity())) {
            ...
            String kodeBooking           = listBookingComplete.get(position).getIdBooking();
            String kodeDealer           = listBookingComplete.get(position).getIdDealer();
